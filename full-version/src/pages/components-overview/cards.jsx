            ...
            <MainCard title="Basic" codeString={basicCardCodeString}>
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <MainCard border={false} sx={(theme) => ({ height: '100%', boxShadow: theme.customShadows.z1 })}>
                    <Typography variant="h6">Card Subtitle</Typography>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <MainCard title="Card Title" border={false} sx={(theme) => ({ height: '100%', boxShadow: theme.customShadows.z1 })}>
                    <Typography variant="h6">Card Subtitle</Typography>
                    <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                      This is card description
                    </Typography>
