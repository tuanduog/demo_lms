...
// assets
import { Add, Coin, InfoCircle, Profile, Setting2, Sms, TickCircle, Trash, Warning2 } from 'iconsax-reactjs';
              ...
              <MainCard title="With Badge" codeString={badgeAvatarCodeString}>
                <Grid container spacing={1}>
                  ...
                  <Grid>
                    <Badge color="error" overlap="circular" variant="dot">
                      <Avatar>
                        <CardMedia component="img" alt="Natacha" src={vector2} sx={{ width: 40 }} />
                      </Avatar>
                    </Badge>
                  </Grid>
                  <Grid>
