...
// assets
import { ArrowDown2, ArrowRight2, CloseCircle, Command, Edit2, Send, TableDocument, HamburgerMenu } from 'iconsax-reactjs';
...
function EditAction({ row, table }) {
  ...
  const setSelectedRow = (e) => {
    meta?.setSelectedRow((old) => ({ ...old, [row.id]: !old[row.id] }));
