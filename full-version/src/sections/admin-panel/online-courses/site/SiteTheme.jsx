...
function UploadFile({ item, file, preview, onDrop, onRemove, sx }) {
...
export default function SiteTheme() {
  ...
  const handleDrop = (label) => (acceptedFiles) => {
...
SectionTitle.propTypes = { title: PropTypes.string, subHeading: PropTypes.string };

UploadFile.propTypes = {
  item: PropTypes.any,
  file: PropTypes.any,
  preview: PropTypes.oneOfType([PropTypes.any, PropTypes.string]),
