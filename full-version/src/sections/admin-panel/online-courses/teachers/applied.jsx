...
// ==============================|| ONLINE COURSES - APPLIED TEACHER ||============================== //

export default function AppliedTeacher() {
        ...
        cell: ({ getValue }) => (
          <Stack>
            ...
            <Typography variant="caption" sx={{ color: 'secondary.500' }}>
              <PatternFormat displayType="text" format="0#:#5 AM" mask="_" defaultValue={getValue()} />
            </Typography>
          </Stack>
        )
      },
