...
// assets
import { Add, ArrowDown2, AttachSquare, Calendar, Edit, TickCircle, Trash } from 'iconsax-reactjs';
          ...
          <SimpleBar sx={{ overflowX: 'hidden', height: '100vh' }}>
            ...
            <Stack sx={{ px: 3, py: 2.5, gap: 3 }} direction="row">
              ...
              <Stack sx={{ gap: 2 }}>
                ...
                <ReactQuillDemo borderRadius={1} value={editorText} />
...
TicketDetailsDrawer.propTypes = { isOpen: PropTypes.bool, handleDrawerOpen: PropTypes.func };
