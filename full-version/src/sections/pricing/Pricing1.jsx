...
export default function Pricing1({ title, description }) {
  const [planValidity, setPlanValidity] = useState('yearly');

  function PlanValidityCard({ value, label, chip }) {
    return (
...
Pricing1.propTypes = { title: PropTypes.string, description: PropTypes.string };
