...
// assets
import { CloseCircle, Setting3, TickCircle } from 'iconsax-reactjs';
              ...
              renderOption={(props, option, { selected }) => {
                ...
                return (
                  <li key={key} {...optionProps}>
                    ...
                    />
                    <Box
                      sx={{ width: 14, height: 14, flexShrink: 0, borderRadius: '3px', mr: 1, mt: '2px' }}
                      style={{ backgroundColor: option.color }}
                    />
                    <Box sx={(theme) => ({ flexGrow: 1, '& span': { color: theme.palette.text.primary } })}>
                      {option.name}
                      <br />
                      <span>{option.description}</span>
                    </Box>
