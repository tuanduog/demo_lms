  ...
  return (
    <MainCard title="Basic Picker" codeString={basicDatepickerCodeString}>
      <LocalizationProvider dateAdapter={AdapterDateFns}>
        <Stack sx={{ gap: 3 }}>
          <DesktopDatePicker format="MM/dd/yyyy" value={value} onChange={(newValue) => setValue(newValue)} />
          <MobileDatePicker format="MM/dd/yyyy" value={value} onChange={(newValue) => setValue(newValue)} />
