...
{
  /* <ListItem
                            key={q.questionSubmissionId}
                            alignItems="flex-start"
                            sx={{ mb: 2 }}
                            secondaryAction={
                              q.isCorrect !== null ? (
                                <Chip label={q.isCorrect ? 'Đúng' : 'Sai'} color={q.isCorrect ? 'success' : 'error'} size="small" />
                              ) : gradingStatus === 'pending' ? (
                                <TextField
                                  placeholder="score here"
                                  value={scoreValue}
                                  onChange={(e) => handleChangeScore(e, q.questionSubmissionId)}
                                  size="small"
                                  variant="outlined"
                                />
                              ) : (
                                <TextField placeholder="score here" value={scoreValue} size="small" variant="outlined" aria-readonly />
                              )
                            }
                          >
                            <ListItemText
