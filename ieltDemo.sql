...
VALUES 
('image', 'https://tse3.mm.bing.net/th/id/OIP.yXZSPrY6e2kCm_UEaq7nDgHaNK?cb=12&rs=1&pid=ImgDetMain&o=7&rm=3'), ('pdf', 'https://drive.google.com/drive/my-drive?hl=vi'), ('text', NULL), ('text', NULL), ('text', NULL),
...
(@section_id, 22, 'Which word is closest in meaning to "meticulous"?', 'mcq', 'Extremely careful and precise'),
(@section_id, 22, 'Choose the correct usage of "nonchalant"', 'mcq', 'Calm and unconcerned'),
(@section_id, 22, 'Select the synonym for "obfuscate"', 'mcq', 'To make unclear or confusing'),
(@section_id, 22, 'Choose the correct meaning of "palpable"', 'mcq', 'Able to be felt or touched'),
(@section_id, 22, 'Identify the word that best completes: "The plan was ___ in every detail."', 'mcq', 'Thorough or complete'),
(@section_id, 22, 'Select the word opposite of "quintessential"', 'mcq', 'Not representative'),
(@section_id, 22, 'Choose the correct usage of "resilient"', 'mcq', 'Able to recover quickly from difficulties'),
(@section_id, 22, 'Pick the synonym of "scrutinize"', 'mcq', 'Examine closely'),
(@section_id, 22, 'Choose the correct antonym of "tenacious"', 'mcq', 'Weak-willed'),
(@section_id, 22, 'Select the word that best fits: "Her comments were highly ___"', 'mcq', 'Insightful'),
(@section_id, 22, 'Which word is closest in meaning to "ubiquitous"?', 'mcq', 'Present everywhere'),
(@section_id, 22, 'Choose the correct usage of "venerable"', 'mcq', 'Commanding respect due to age or dignity'),
